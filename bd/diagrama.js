...
const DOMAINS = [
  {
    ...
    tables: [
      { name: 'tenant', cols: [
        ...
        { n: 'estado', t: 'varchar(20)', nn: true, def: 'ativo', note: 'ativo, suspensa, expirada' },
        { n: 'plano', t: 'varchar(50)', nn: true, def: 'basico', note: 'basico, profissional, enterprise' },
        { n: 'licenca_validade', t: 'timestamptz' },
  ...
  },
  {
    id: 'escolas',
    name: 'Escolas',
    desc: 'Gestao de escolas, anos lectivos, infraestruturas e configuracoes',
    color: 'escolas',
    tables: [
      { name: 'escola', cols: [
        { n: 'id', t: 'uuid', pk: true },
        ...
        { n: 'tipo', t: 'varchar(50)', def: 'publica', note: 'publica, privada, comparticipada' },
        ...
        { n: 'email', t: 'varchar(255)' },
        { n: 'latitude', t: 'float', note: 'GPS' },
        { n: 'longitude', t: 'float', note: 'GPS' },
      ...
      { name: 'infraestrutura', cols: [
        ...
        { n: 'escola_id', t: 'uuid', nn: true, fk: 'escolas.escola' },
        { n: 'nome', t: 'varchar(255)', nn: true },
        { n: 'tipo', t: 'varchar(50)', def: 'sala_aula', note: 'sala_aula, laboratorio, biblioteca, ...' },
        { n: 'capacidade', t: 'integer' },
        { n: 'estado', t: 'varchar(30)', def: 'operacional' },
